...
function Page() {
  ...
  return (
    <main className='min-h-screen w-full bg-gray-50 dark:bg-gray-900 flex flex-col'>
      <div className='bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 shadow-sm flex-shrink-0'>
      ...
      <div className='flex-1 min-h-0 overflow-hidden'>
        <div className='max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-4 sm:py-8 h-full'>
          <div className='grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-6 h-full'>
            ...
            <div className='lg:col-span-9 order-1 lg:order-2 h-full min-h-0'>
                  ...
                  <div className="flex-1 min-h-0 overflow-hidden">
                    ...
                    <TabsContent value="chat" className="mt-0 h-full">
                      <div className="h-full px-3 sm:px-6 py-4">
                        <ChatUI 
                          documentId={documentname as string}
                          isAnalysisReady={summary.short_summary !== undefined && !analysisLoading}
                        />
                      </div>
                    </TabsContent>
                  </div>
