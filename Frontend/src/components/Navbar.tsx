...
import { Upload,Mail,Scale } from 'lucide-react'
...
function Navbar() {
  return (
    <nav className='sticky top-0 z-10 bg-white shadow-md p-4 md:p-6 w-full text-black '>
      ...
      <a href='#' className="font-bold text-3xl "><span className='flex gap-2'>Upload<Upload size={35}/></span></a>
      <a href='#' className="font-bold text-3xl "><span className='flex gap-2'>Contact<Mail size={35}/></span></a>
